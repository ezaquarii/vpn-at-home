"""openvpnathome URL Configuration
...
from openvpnathome.apps.openvpn.urls import api_urlpatterns as openvpn_api_urls
from openvpnathome.apps.openvpn.urls import views_urlpatterns as openvpn_views_urls
from openvpnathome.apps.frontend.views import FrontendView
