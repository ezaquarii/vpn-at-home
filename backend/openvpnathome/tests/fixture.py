...
class BaseFixtureMixin(object):
    ...
    * test dhparams
    ...
    # real e-mail account.
    TEST_USER_ADMIN = 'admin@openvpnathome.net'
    TEST_USER_ALPHA = 'alpha@openvpnathome.net'
    TEST_USER_BRAVO = 'bravo@openvpnathome.net'
    TEST_USER_CHARLIE = 'charlie@openvpnathome.net'
